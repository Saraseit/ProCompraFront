...
const s = {
  ...
  toast: { display: 'flex', alignItems: 'flex-start', gap: 10, padding: '12px 14px',
           ...
           boxShadow: '0 12px 30px rgba(0,0,0,0.16)', background: 'var(--pc-superficie)',
  ...
  toastError: { border: '1px solid var(--pc-rojo-borde)', borderLeft: `4px solid ${C.rojo}`, color: C.rojo },
  icono: { fontWeight: 700 },
  mensaje: { fontSize: 14, color: 'var(--pc-texto-suave)', margin: 0, lineHeight: 1.5 },
  ...
  btnPrimario: { background: 'var(--pc-btn)', color: 'var(--pc-btn-texto)', border: 'none', padding: '10px 16px',
                 borderRadius: 9, fontSize: 13, fontWeight: 600 },
  btnPeligro: { background: 'var(--pc-rojo-solido)', color: '#fff', border: 'none', padding: '10px 16px',
                borderRadius: 9, fontSize: 13, fontWeight: 600 },
}
